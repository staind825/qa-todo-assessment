!function () {
    ...
    var s = function (e) {
        ...
        e.template = function (a, o, s) {
            var i;
            s = e.defaults({}, s, e.templateSettings);
            var c = new RegExp([
                (s.escape || t).source,
                (s.interpolate || t).source,
                (s.evaluate || t).source
            ].join("|") + "|$", "g");
            ...
            a.replace(c, function (e, t, o, s, i) {
                l += a.slice(u, i).replace(r, function (e) {
                    return "\\" + n[e];
                });
            ...
            f.source = "function(" + (s.variable || "obj") + "){\n" + l + "}";
            return f;
        };
        return e;
    }({});
    ...
    // Learn sidebar prototype methods
    c.prototype.append = function (e) {
        var t = document.createElement("aside");
        t.innerHTML = s.template(this.template, this.frameworkJSON);
        t.className = "learn";
        ...
        if (e && e.backend) {
            ...
            Array.prototype.forEach.call(c, function (e) {
                if ("http" !== e.getAttribute("href").substr(0, 4)) {
                    e.setAttribute("href", i() + e.getAttribute("href"));
                }
            });
        }
        ...
        if (e) {
            ...
            n.onload = function (t) {
                ...
                if (n instanceof Array) {
                    var r = n.length;
                    if (0 !== r) {
                        e.innerHTML = "This app has " + r + " open issues";
    ...
    if ("tastejs.github.io" === location.hostname) {
